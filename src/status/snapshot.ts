...
import type { BuildProjectSummary } from "../dashboard/types.js";
import { projectBuildProject } from "../dashboard/projections.js";
...
export function buildStatusSnapshot(input: StatusInput): StatusSnapshot {
  ...
  return {
    ...
    buildProject: projectBuildProject(input.buildProjects?.currentProject() ?? null),
    goal: input.goal,
