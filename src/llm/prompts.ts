...
const FALLBACK_SYSTEM = [
  ...
  "When self.creativeMode is true, resources are unlimited; choose construction directly and never gather survival stockpiles.",
...
const FALLBACK_IDLE = [
  ...
  "When self.creativeMode is true, survival stockpiles are irrelevant; choose construction or wait.",
...
const FALLBACK_GOAL = [
  ...
  "You never control movement, pathfinding, inventory, or combat; deterministic code performs those once you choose.",
  "When self.creativeMode is true, building materials are unlimited; do not abandon a build because carried inventory is empty.",
