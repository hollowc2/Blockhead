...
const SNAPSHOT: StateSnapshot = {
  ...
  inventory: {
    food: 7,
    torches: 19,
    wood: { logs: 41, planks: 0, sticks: 3 },
    fuel: 6,
    iron: 0,
    materials: { cobblestone: 12 },
    freeSlots: 14,
  },
  equipment: {
    held: { name: "iron_pickaxe", durability: { used: 23, max: 60 } },
    offhand: null,
    armor: [{ name: "leather_helmet" }],
  },
  home: {
    known: true,
    distance: 93,
    dimension: "overworld",
    storage: { chests: 1, categories: ["general"] },
    stockpile: null,
  },
  recentEvents: [],
  recentTasks: [],
